...
```
wget -O js/lib/useless.js https://raw.github.com/mlensment/useless.js/master/useless.js
wget -O js/lib/mustache.js https://raw.github.com/mlensment/useless.js/master/test-application/client/js/lib/mustache.js
wget -O js/lib/jquery.js http://code.jquery.com/jquery-1.10.2.js
wget -O package.json https://raw.github.com/mlensment/useless.js/master/test-application/client/package.json
```
...
Because server.js in the test-application is somewhat changed, we need to create our own.
...
We can already start up server by typing `node server.js`
